...
public class UserController {
    ...
    /*
        securityContext - получение текущего контекста
        userDetails - возвращает конкретного пользователя UserDetails
     */
    @GetMapping("/{id}")
    ...
    // Операции на добавление новго пользователя
...
//    @ResponseStatus(HttpStatus.CREATED)
    ...
    // Операции на Обновление нашей сущности
    ...
    // Операции на удаление нашей сущности
//    @DeleteMapping("/{id}")
